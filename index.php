...
<body>
  <header>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="navbar-brand" href="index.html">HTTP</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link" href="requisicao.html">Requisições</a>
        </div>
      </div>
    </nav>
  </header>
  <main class="cont">
    ...
    <div class="card-deck">
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">HTTP é um protocolo (protocol) que permite a obtenção de recursos, tais como documentos
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">As mensagens de cabeçalho HTTP são utilizadas para realizar a descrição de algum recurso
            ou comportamento
            do cliente ou servidor. Propriedades customizadas nos cabeçalhos utilizam o prefixo 'X-' ; Outras no
            registro IANA, cujo conteúdo original foi definido na RFC 4229. IANA também mantém o registro de novas
    ...
    <div class="card-deck">
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">As mais diferentes requisições podem ser utilizadas pelos métodos de requisições HTTP:
            GET e POST, mas
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">O funcionamento dos cookies é definido pela RFC 6265. Ao receber uma requisição HTTP, o
            servidor pode
    ...
    <div class="card-deck">
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">O Cache é muito importante para websites rápidos. Este artigo descreve diferentes métodos
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">Os códigos de status do HTTP indicam quando uma requisição foi completada. Códigos de
            status são agrupados em cinco classes: Informações, respostas, respostas de sucesso, redirecionamentos,
    ...
    <div class="card-deck">
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">Uma breve descrição das mudanças que ocorreram no HTTP em versões mais antigas para o
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">Descreve os tipos e a estrutura das diferentes mensagens do HTTP/1.x e HTTP/2.</p>
        </div>
      </div>
    </div>
    <div class="card-deck">
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">Descreve os três modelos de conexão disponíveis no HTTP/1.x, seus pontos fortes e fracos.
          </p>
        </div>
      </div>
    </div>
    <div class="card-deck">
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">As requisições CORS são requisições HTTP de recursos de domínios diferentes do domínio
            que está fazendo a requisição. um exemplo é um site A (SiteA.com) realizando uma requisição de uma imagem
            por meio de um elemento img para um site B (SiteB.com/img.png). Hoje em dia encontramos o CORS em grande
      ...
      <div class="card text-white bg-dark border-light">
        <div class="card-body">
          ...
          <p class="card-text">O Firefox e outros navegadores atuais utilizam a pré-busca de DNS, ou seja, o navegador
            faz a busca do nome do domínio nos links contidos numa página antes que o recurso seja requisitado, como por
            exemplo imagens, scripts e folhas de estilo. Isto tudo ocorre em segundo plano, para que quando o recurso
            necessite ser carregado, o endereço DNS já esteja resolvido. Isto diminui a latência quando, por exemplo, um
    ...
    <h4><a href="https://www.html5rocks.com/pt/tutorials/internals/howbrowserswork/">Como os navegadores funcionam</a></h4>
    <p class="p3">Um artigo bem abrangente sobre a parte interna dos navegadores e os fluxos de requisições via protocolo HTTP. O
